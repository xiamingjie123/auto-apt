...
return {
  ...
  assert.equal(api.normalizePersistentSettingValue('fiveSimReuseEnabled', 0), false);
  assert.equal(api.normalizePersistentSettingValue('fiveSimReuseEnabled', 1), true);
